...
getMyComments: async ({ userId, page, limit }) => {
  try {
    ...
    logger.info('User comments fetched', { userId, count: comments.length });
    ...
    logger.error('Get my comments failed', { error: error.message, userId });
    return {
      success: false,
  ...
  addComment: async ({ userId, blogId, content, parentId = null }) => {
    ...
    parentId: parentId ? new mongoose.Types.ObjectId(parentId) : null,
      ...
      logger.error('Add comment failed', { error: error.message, userId, blogId });
      return {
        success: false,
  ...
  updateComment: async ({ userId, commentId, content }) => {
    try {
      ...
      logger.error('Update comment failed', { error: error.message, userId, commentId });
      return {
        success: false,
  ...
  deleteComment: async ({ userId, commentId }) => {
    try {
      ...
      logger.error('Delete comment failed', { error: error.message, userId, commentId });
      return {
        success: false,
