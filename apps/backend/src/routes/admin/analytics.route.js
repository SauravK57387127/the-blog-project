...
router.get(
  '/writing-streak',
  AnalyticsController.getWritingStreak
);
...
router.get(
  '/sidebar-stats',
  AnalyticsController.getSidebarStats
);
...
router.get(
  '/recent-draft',
  AnalyticsController.getRecentDraft
);
...
router.get(
  '/scheduled-upcoming',
  AnalyticsController.getScheduledUpcoming
);
...
router.get(
  '/stale-drafts',
  AnalyticsController.getStaleDrafts
);
