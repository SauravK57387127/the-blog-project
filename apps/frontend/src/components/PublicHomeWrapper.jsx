...
const PopularPostsSection = dynamic(
    () => import("@/components/home/PopularPostsSection"),
);
const EditorsChoiceSection = dynamic(
    () => import("@/components/home/EditorsChoiceSection"),
);
