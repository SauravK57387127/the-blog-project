...
import {
    useAdminProfile,
    useAdminLogout,
} from "@/hooks/api/admin/useAdminProfile";
            ...
            >
                ...
                >
                    ...
                    {navItems.map((item, index) => {
                        ...
                        return (
                            <Link
                                ...
                                style={{
                                    transform: `scale(${scale}) translateY(${getTranslateY(scale)})`,
                                }}
                            >
                                <div
                    ...
                    <button
                        ...
                        style={{
                            transform: `scale(${getScale(THEME_IDX)}) translateY(${getTranslateY(getScale(THEME_IDX))})`,
                        }}
                    >
                        <div
                    ...
                    <button
                        ...
                        className="relative flex flex-col items-center transition-all duration-300 ease-out"
                        style={{
                            transform: `scale(${getScale(AVATAR_IDX)}) translateY(${getTranslateY(getScale(AVATAR_IDX))})`,
                        }}
                        ...
                        >
                            <img
                                src={
                                    ...
                                    "https://avatars.githubusercontent.com/u/190694463?s=400&v=4"
                                }
