    ...
    return (
        <div className="min-h-screen w-full pb-24">
            <header className="sticky top-0 z-40 border-b border-border/40 bg-background/80 backdrop-blur-md shadow-sm">
                <div
                    className={`flex h-16 items-center gap-3 ${DESIGN_CONSTANTS.containers.standard} mx-auto px-4 sm:px-6 lg:px-8`}
                >
                    <svg
                        width="26"
                        height="26"
                    ...
                    <div className="flex flex-col justify-center">
                        <h1 className="text-lg font-light leading-none">
                            ...
                            <span className="font-mono text-xs text-muted-foreground ml-2 tracking-widest uppercase not-italic">
                                · admin
                            </span>
                        </h1>
