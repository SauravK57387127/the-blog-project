  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label:   "text-xs font-mono font-medium uppercase tracking-widest text-foreground",
        ...
        weekday:  "text-muted-foreground w-9 text-center text-[10px] font-mono uppercase tracking-wide pb-1",
        ...
        selected:  "[&>button]:border-foreground [&>button]:bg-foreground [&>button]:text-background",
