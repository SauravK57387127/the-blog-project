  ...
  return (
    <section className={`${DESIGN_CONSTANTS.spacing.section} bg-muted/30`}>
      <div className={`${DESIGN_CONSTANTS.containers.standard} mx-auto px-4 sm:px-6 lg:px-8`}>
        ...
        <div className={`flex flex-col items-center text-center gap-1 ${DESIGN_CONSTANTS.spacing.header}`}>
          <span className="text-xs font-mono font-medium uppercase tracking-widest text-muted-foreground">
            — picked by me, for you —
          </span>
          <h2 className="text-2xl font-sans font-bold">Editor's Choice</h2>
        </div>
