...
export default function CTASection() {
    return (
        <section className="relative py-24 overflow-hidden bg-gradient-to-b from-background via-muted/20 to-background">
            <div
                className={`relative z-10 ${DESIGN_CONSTANTS.containers.standard} mx-auto px-4 sm:px-6 lg:px-8`}
            >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="text-center space-y-6 p-8 border-4 border-foreground">
                        ...
                        <p className="text-base text-foreground font-mono font-medium">
                            I'm{" "}
                            <span className="border border-border px-1.5 py-0.5 text-accent">
                                SAURAV
                            </span>{" "}
                            — a self-taught dev figuring things out, one line at
                            a time.
                        </p>
                        <Link
                            href="/about"
                    ...
                    <div className="text-center space-y-6 p-8 border-4 border-foreground">
                        ...
                        <p className="text-base text-foreground font-mono font-medium">
                            Real dev. Real struggles. Real progress — delivered
                            to you.
                        </p>
                        <Link
                            href="/newsletter"
