...
const learningAreas = [
    { label: "Full-stack", detail: "MERN stack, building end-to-end apps" },
    { label: "React & Next.js", detail: "Modern web with Server Components" },
    { label: "DSA", detail: "Problem-solving & algorithms" },
];

const currentFocus = [
    { label: "LeetCode grind", detail: "Solving DSA daily" },
    { label: "Full-stack projects", detail: "Building real applications" },
    { label: "ML exploration", detail: "Diving into machine learning" },
];

const writingTopics = [
    { label: "Tech deep-dives", detail: "Code tutorials & insights" },
    { label: "Life experiences", detail: "Real stories, honest lessons" },
    { label: "Self-taught journey", detail: "Learning without college" },
];
...
const socialLinks = [
    ...
    { name: "LeetCode", icon: Code, url: "https://leetcode.com/yourusername" },
        ...
        <div className="w-full min-h-screen">
            ...
            >
                ...
                >
                    ...
                    <section className="mb-16">
                        <div className="flex flex-col md:flex-row gap-8 items-start">
                            ...
                            <div className="w-32 h-32 rounded-full flex-shrink-0 overflow-hidden bg-muted ring-2 ring-border">
                                <img
                                    src="https://avatars.githubusercontent.com/u/190694463?s=400&u=67216f47b22ebd87e7760ca4c87c3ee808ae4d6d&v=4"
                    ...
                    {/* My Journey — plain editorial text, no card */}
                    <section className="mb-16">
                        ...
                        <p className="font-reading text-lg leading-relaxed text-foreground/80">
                            Navigating tutorial hell, DSA struggles, and
                            self-doubt — this blog isn't just about tech. It's
                            about the whole journey: building projects,
                            practicing meditation, finding balance in a
                            sedentary dev life. Shared honest experiences,
                            technical deep-dives, and life lessons from someone
                            still figuring it out.
                        </p>
                    </section>

                    {/* Quick Info — borderless rows, mono headers */}
                    <section className="mb-16">
                                ...
                                <ul className="space-y-4">
                                    {learningAreas.map((item) => (
                                        ...
                                        >
                                            ...
                                            <p className="font-reading text-sm text-muted-foreground mt-0.5">
                                                {item.detail}
                                            </p>
                                        </li>
                                    ))}
                            ...
                            {categoryCards.map((card) => (
                                ...
                                >
                                    <div className="flex items-center gap-5">
                                        ...
                                        <div>
                                            <h3
                                                className={`font-sans font-bold text-base group-hover:text-accent ${DESIGN_CONSTANTS.transitions.fast}`}
                                            >
                                                {card.title}
                                            </h3>
                                    ...
                                    <ArrowRight
                                        className={`h-4 w-4 text-muted-foreground/40 group-hover:text-accent group-hover:translate-x-1 ${DESIGN_CONSTANTS.transitions.fast} flex-shrink-0`}
                                    />
                                </div>
                            ))}
                        </div>
            ...
            >
                <div
                    className={`${DESIGN_CONSTANTS.containers.narrow} mx-auto px-4 sm:px-6 lg:px-8`}
                >
                    {/* Section Header */}
                    ...
                    <p className="font-reading text-base text-foreground/70 mb-8 max-w-md">
                        Whether it's feedback, a collab idea, or just a hello —
                        I'm always around.
                    </p>
