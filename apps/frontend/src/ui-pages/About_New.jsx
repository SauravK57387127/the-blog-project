        ...
        <div className={`${DESIGN_CONSTANTS.containers.narrow} mx-auto`}>
              ...
              <div className="flex-1">
                <blockquote className="border-l-4 border-foreground pl-6 py-2">
                  <p className="text-2xl md:text-3xl font-serif italic leading-relaxed mb-4 text-foreground">
                    Finding balance between code, growth, and peace as I quietly shape the world within me.
                  </p>
          ...
          <section className="mb-16">
            ...
            <p className="font-reading text-lg leading-relaxed text-foreground/80">
              Navigating tutorial hell, DSA struggles, and self-doubt — this blog isn't just about tech.
              It's about the whole journey: building projects, practicing meditation, finding balance
              in a sedentary dev life. Shared honest experiences, technical deep-dives, and life
              lessons from someone still figuring it out.
            </p>
          </section>
