...
import {
    ...
    useToggleLike,
    useToggleBookmark,
} from "@/hooks/api/user/useEngagement";
...
const CommentSection_New = dynamic(
    () => import("@/components/blog/CommentSection"),
);
const RelatedBlogs_New = dynamic(
...
export default function BlogDetail({ blog, slug }) {
    ...
    const { data: engagement, isLoading: isEngagementLoading } = useEngagement(
        blog?._id,
    );
