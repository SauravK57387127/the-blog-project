...
const demoDrafts = [
    {
        ...
        excerpt:
            "A comprehensive guide to React Server Components, their benefits, and how to use them effectively in modern applications.",
        updatedAt: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString(),
        wordCount: 840,
    },
    {
        _id: "d2",
        title: "My LeetCode Journey: 100 Days In",
        excerpt:
            "Reflections on solving problems daily, patterns I've learned, and how it's changed my approach to coding interviews.",
        updatedAt: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(),
        wordCount: 1200,
    },
    {
        _id: "d3",
        title: "Why I Started Meditating as a Developer",
        excerpt:
            "How mindfulness practice has improved my focus, reduced burnout, and made me a better problem solver.",
        updatedAt: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000).toISOString(),
        wordCount: 430,
    },
    {
        _id: "d4",
        title: "Building a Full-Stack Blog with Next.js",
        excerpt: "",
    ...
    return (
        <div className="flex flex-col items-center justify-center py-20 space-y-4">
            ...
            <p className="text-sm font-reading text-muted-foreground max-w-sm text-center">
                Start writing your first post and save it as a draft to continue
                later.
            </p>
            <button
                onClick={onCreateNew}
