        ...
        <AdminLayout_New>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className={`${showPreview ? "hidden lg:block" : "block"}`}>
                    <div
                        className="border border-border overflow-auto custom-scroll"
                ...
                <div className={`${showPreview ? "block" : "hidden lg:block"}`}>
                    <div
                        className="border border-border border-l-2 border-l-foreground/20 overflow-auto custom-scroll"
                        style={{ height: "calc(100vh - 360px)" }}
                    >
                        <div className="p-6">
                            <BlogPreview
