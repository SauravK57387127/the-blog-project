...
const ViewsSparkline = dynamic(
    () => import("@/components/admin/ViewsSparkline"),
    { loading: () => <div className="h-48 bg-muted animate-pulse rounded" /> },
);
const TopPostsTable = dynamic(
    () => import("@/components/admin/TopPostsTable"),
    { loading: () => <div className="h-48 bg-muted animate-pulse rounded" /> },
);
const CategoryBreakdown = dynamic(
    () => import("@/components/admin/CategoryBreakdown"),
    { loading: () => <div className="h-48 bg-muted animate-pulse rounded" /> },
);
const BestMoments = dynamic(() => import("@/components/admin/BestMoments"), {
...
function StatTile({ title, value, sub, highlight = false, isLoading }) {
    return (
        <div
            className={`p-6 border-2 ${highlight ? "border-foreground" : "border-border"}`}
        >
            ...
            <div className="space-y-12">
                ...
                <section className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <StatTile
                        ...
                        sub={
                            overview?.subscribers?.newThisMonth != null
                                ? `+${overview.subscribers.newThisMonth} this month`
                                : ""
                        }
                        isLoading={overviewLoading}
                    />
