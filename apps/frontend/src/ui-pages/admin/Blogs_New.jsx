...
import { Search, Trash2, Eye, Edit3, Send, X, ArrowRight } from "lucide-react";
...
const demoBlogs = [
    ...
    },
    {
        ...
        slug: "the-self-taught-developers-journey",
        excerpt:
            "Reflections on learning to code independently and building a career without a CS degree.",
        coverImage:
    ...
    },
    {
        ...
        slug: "building-better-habits-as-a-developer",
        excerpt:
            "How daily routines, meditation, and consistent practice transformed my coding skills.",
        coverImage:
            "https://images.unsplash.com/photo-1499750310107-5fef28a66643?w=800&h=400&fit=crop",
        tags: ["productivity", "habits", "mindfulness"],
    ...
    },
    {
        ...
        excerpt:
            "Deep dive into generics, conditional types, and mapped types for building type-safe applications.",
        coverImage:
    ...
    },
    {
        ...
        slug: "why-i-started-meditating-daily",
        excerpt:
            "The impact of a consistent meditation practice on focus, creativity, and problem-solving.",
        coverImage:
