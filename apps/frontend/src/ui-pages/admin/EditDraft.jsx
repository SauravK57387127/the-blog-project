...
const [excerpt, setExcerpt] = useState("");
  ...
  const fileInputRef = useRef(null);
    ...
    const { mutate: schedule, isPending: isScheduling } =
        useScheduleBlog(blogId);
    ...
    <p className="text-[9px] font-mono text-muted-foreground/50 mt-0.5">
        {excerpt.length}/180
                                ...
                                >
                                    {coverImage ? (
                                        <img
                                            src={coverImage}
                                            alt="Cover"
                                            className="w-12 h-7 object-cover border border-border"
                                        />
                                    ) : (
                                    ...
                                    {coverInput && (
                                        <div className="aspect-video overflow-hidden border border-border">
                                            <img
                                                ...
                                                onError={(e) => {
                                                    e.currentTarget.src =
                                                        "https://via.placeholder.com/800x400?text=Invalid";
                                                }}
                                            />
                                        </div>
                                    )}
                                    ...
                                    <div>
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {tags.map((tag) => (
                                                <span
                                                    key={tag}
                                                    className="inline-flex items-center gap-1 px-2 py-1 text-xs font-mono border border-border"
                                                >
                                                    {tag}
                                                    <button
                                                        onClick={() =>
                                                        ...
                                                        className={`hover:text-destructive ${DESIGN_CONSTANTS.transitions.fast}`}
                                                    >
                                                        <X className="h-3 w-3" />
                                                    </button>
                                                </span>
                                            ...
                                            {tags.length === 0 && (
                                                <p className="text-xs font-reading text-muted-foreground italic">
                                                    No tags yet
                                                </p>
                                            )}
                                        </div>
                    ...
                    <div className="px-4 py-3 flex-shrink-0">
                        ...
                        <button
                            onClick={handleToggleEditorsPick}
                        ...
                        >
                            <Star
                                className={`h-3.5 w-3.5 ${isEditorsPick ? "fill-accent" : ""}`}
                            />
                ...
                <DialogContent>
                    ...
                    <div className="space-y-4">
                        <textarea
                            ...
                            onChange={(e) =>
                                setPickAnnotationDraft(e.target.value)
                            }
                        ...
                        <p className="text-[10px] font-mono text-muted-foreground">
                            {pickAnnotationDraft.length}/200
                        </p>
                        <div className="flex justify-end gap-2">
                            <button
