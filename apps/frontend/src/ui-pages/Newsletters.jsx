...
import { useNewsletterSubscribe } from '@/hooks/api/public/useNewsletter';
...
export default function Newsletter() {
  ...
  return (
    <div className="w-full min-h-[80vh] flex items-center">
      <div className={`${DESIGN_CONSTANTS.containers.standard} mx-auto px-4 sm:px-6 lg:px-8 py-20`}>
          ...
          <div className="space-y-10">
            ...
            <div className="space-y-4">
              <h1 className={`${DESIGN_CONSTANTS.typography.heroTitle}`}>
                I write.<br />You read.<br />
                <span className="font-serif italic">That's the deal!</span>
              </h1>
              ...
              <ul className="space-y-0">
                {[
                  ...
                  >
                    ...
                    <span className="font-reading text-foreground/80">{item}</span>
                  </li>
                ))}
              </ul>
            </div>
          ...
          <div className="space-y-8">
            <div className="space-y-2">
              ...
              <p className="font-reading text-sm text-muted-foreground">
                Drop your email. Unsubscribe whenever. No spam, ever.
              </p>
            </div>
