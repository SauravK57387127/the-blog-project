...
import {
    ...
    useHistory,
} from "@/hooks/api/user/useProfile";
...
export default function UserProfile() {
    ...
    const { data: bmData, isLoading: bmLoading } = useMyBookmarks({
        page: bmPage,
    });
    const { data: histData, isLoading: histLoading } = useHistory({
        page: histPage,
    });
    ...
    const { data: commData, isLoading: commLoading } = useQuery({
        ...
        queryFn: () =>
            apiClient.get(API_ENDPOINTS.USER.COMMENTS.MY, {
                params: { page: commPage, limit: 10 },
            }),
        staleTime: 60 * 1000,
        select: (r) => r.data,
    });
