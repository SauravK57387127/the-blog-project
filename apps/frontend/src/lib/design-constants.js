...
export const DESIGN_CONSTANTS = {
  ...
  grids: {
    ...
    popularPosts: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5",
    topics: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4",
  },

  // Typography
typography: {
  heroTitle: "text-4xl md:text-5xl lg:text-6xl font-sans font-bold leading-tight",
